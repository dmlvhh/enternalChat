const dataJson = [
  ...
  // { children: [], label: '重庆市', value: '10003' },
  {
    ...
    value: '10000',
    children: [
      { label: '东城区', value: '10000-01' },
      { label: '西城区', value: '10000-02' },
      { label: '朝阳区', value: '10000-03' },
      { label: '丰台区', value: '10000-04' },
      { label: '石景山区', value: '10000-05' },
      { label: '海淀区', value: '10000-06' },
      { label: '门头沟区', value: '10000-07' },
      { label: '房山区', value: '10000-08' },
      { label: '通州区', value: '10000-09' },
      { label: '顺义区', value: '10000-10' },
      { label: '昌平区', value: '10000-11' },
      { label: '大兴区', value: '10000-12' },
      { label: '怀柔区', value: '10000-13' },
      { label: '平谷区', value: '10000-14' },
      { label: '密云区', value: '10000-15' },
      { label: '延庆区', value: '10000-16' }
    ]
  },
  {
    label: '上海市',
    value: '10001',
    children: [
      { label: '黄浦区', value: '10001-01' },
      { label: '徐汇区', value: '10001-02' },
      { label: '长宁区', value: '10001-03' },
      { label: '静安区', value: '10001-04' },
      { label: '普陀区', value: '10001-05' },
      { label: '虹口区', value: '10001-06' },
      { label: '杨浦区', value: '10001-07' },
      { label: '闵行区', value: '10001-08' },
      { label: '宝山区', value: '10001-09' },
      { label: '嘉定区', value: '10001-10' },
      { label: '浦东新区', value: '10001-11' },
      { label: '金山区', value: '10001-12' },
      { label: '松江区', value: '10001-13' },
      { label: '青浦区', value: '10001-14' },
      { label: '奉贤区', value: '10001-15' },
      { label: '崇明区', value: '10001-16' }
    ]
  },
  {
    label: '天津市',
    value: '10002',
    children: [
      { label: '和平区', value: '10002-01' },
      { label: '河东区', value: '10002-02' },
      { label: '河西区', value: '10002-03' },
      { label: '南开区', value: '10002-04' },
      { label: '河北区', value: '10002-05' },
      { label: '红桥区', value: '10002-06' },
      { label: '东丽区', value: '10002-07' },
      { label: '西青区', value: '10002-08' },
      { label: '津南区', value: '10002-09' },
      { label: '北辰区', value: '10002-10' },
      { label: '武清区', value: '10002-11' },
      { label: '宝坻区', value: '10002-12' },
      { label: '滨海新区', value: '10002-13' },
      { label: '宁河区', value: '10002-14' },
      { label: '静海区', value: '10002-15' },
      { label: '蓟州区', value: '10002-16' }
    ]
  },
  {
    label: '重庆市',
    value: '10003',
    children: [
      { label: '万州区', value: '10003-01' },
      { label: '涪陵区', value: '10003-02' },
      { label: '渝中区', value: '10003-03' },
      { label: '大渡口区', value: '10003-04' },
      { label: '江北区', value: '10003-05' },
      { label: '沙坪坝区', value: '10003-06' },
      { label: '九龙坡区', value: '10003-07' },
      { label: '南岸区', value: '10003-08' },
      { label: '北碚区', value: '10003-09' },
      { label: '綦江区', value: '10003-10' },
      { label: '大足区', value: '10003-11' },
      { label: '渝北区', value: '10003-12' },
      { label: '巴南区', value: '10003-13' },
      { label: '黔江区', value: '10003-14' },
      { label: '长寿区', value: '10003-15' },
      { label: '江津区', value: '10003-16' },
      { label: '合川区', value: '10003-17' },
      { label: '永川区', value: '10003-18' },
      { label: '南川区', value: '10003-19' },
      { label: '璧山区', value: '10003-20' },
      { label: '铜梁区', value: '10003-21' },
      { label: '潼南区', value: '10003-22' },
      { label: '荣昌区', value: '10003-23' },
      { label: '开州区', value: '10003-24' },
      { label: '梁平区', value: '10003-25' },
      { label: '武隆区', value: '10003-26' }
    ]
  },
  {
    children: [
  ...
  {
    children: [
      { label: '海口市', value: '10222' },
      { label: '三亚市', value: '10223' },
      { label: '三沙市', value: '10224' },
      { label: '儋州市', value: '10225' },
      { label: '五指山市', value: '10226' },
      { label: '琼海市', value: '10227' },
      { label: '文昌市', value: '10228' },
      { label: '万宁市', value: '10229' },
      { label: '东方市', value: '10230' }
    ],
    label: '海南省',
    value: '10221'
  },
  {
    children: [
      { label: '拉萨市', value: '10232' },
      { label: '日喀则市', value: '10233' },
      { label: '昌都市', value: '10234' },
      { label: '林芝市', value: '10235' },
      { label: '山南市', value: '10236' },
      { label: '那曲市', value: '10237' },
      { label: '阿里地区', value: '10238' }
    ],
    label: '西藏自治区',
    value: '10231'
  },
  {
    children: [
      { label: '银川市', value: '10240' },
      { label: '石嘴山市', value: '10241' },
      { label: '吴忠市', value: '10242' },
      { label: '固原市', value: '10243' },
      { label: '中卫市', value: '10244' }
    ],
    label: '宁夏回族自治区',
    value: '10239'
  },
  {
    children: [
      { label: '乌鲁木齐市', value: '10246' },
      { label: '克拉玛依市', value: '10247' },
      { label: '吐鲁番市', value: '10248' },
      { label: '哈密市', value: '10249' },
      { label: '和田地区', value: '10250' },
      { label: '阿克苏地区', value: '10251' },
      { label: '喀什地区', value: '10252' },
      { label: '阿图什市', value: '10253' },
      { label: '博尔塔拉蒙古自治州', value: '10254' },
      { label: '昌吉回族自治州', value: '10255' },
      { label: '巴音郭楞蒙古自治州', value: '10256' },
      { label: '伊犁哈萨克自治州', value: '10257' }
    ],
    label: '新疆维吾尔自治区',
    value: '10245'
  }
